...
export const UserDetailCardComponent: FC<IUserDetailCardComponentProps> = (props) => {
    ...
    return (
        <Card>
                ...
                />
                <CardActions>
                    <LoadingButton size="large" loading={props.isLoadingSetFavorite} color={props.userDetail.favorite ? 'warning' : 'inherit'} onClick={() => props.onSetFavoriteUser(props.userDetail)}>
